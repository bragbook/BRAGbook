        ...
        <div id="postbox-container" class="postbox-container">
            <div class="meta-box-sortables ui-sortable" id="normal-sortables">
                <div class="postbox " id="test1">
                    <div title="Click to toggle" class="handlediv"><br></div><h3 class="hndle"><span>BRAGbook Basic Options <small>(required)</small></span></h3>
                    <div class="inside">
  ...
  <td><select name="revThumbLimit" id="revThumbLimit">
    ...
    <option value="100" <?php if(get_option('revThumbLimit') == "100"){ echo 'selected="selected"'; } ?>>100</option>
                ...
                <div class="postbox closed" id="secondaryinstalls">
                    ...
                    <h3 class="hndle"><span>BRAGbook Secondary Installs<small> (optional)</small></span></h3>
                  <div class="inside">
...
<td><input type="text" name="revPageId5" value="<?php echo get_option('revPageId5'); ?>"  style="width:100%;" /></td>
                ...
                <div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div>
                    <h3 class="hndle"><span>Landing Pages Content <small>(optional)</small></span></h3>
                    <div class="inside">
...
<p>&nbsp;</p>
                ...
                <div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div>
                    <h3 class="hndle"><span>Secondary Landing Pages Content <small>(optional)</small></span></h3>
                    <div class="inside">
                    <p>This content will appear at the top of the specified pages.</p>
                    <hr />
                    <h3>Gallery 2</h3>
...
<div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div><h3 class="hndle"><span>SEO Settings <small>(optional)</small></span></h3>
                    <div class="inside">
...
<td><input name="revUseWPseo" type="checkbox" id="revUseWPseo" value="1" <?php if( get_option('revUseWPseo') == 1){echo 'checked="checked"';} ?> /></td>
                ...
                <div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div>
                    <h3 class="hndle"><span>Secondary Install SEO Settings <small>(optional)</small></span></h3>
                  <div class="inside">
                        <hr />
                        <h3>Gallery 2</h3>
                        <hr />
...
<td><input type="text" name="revCategoryLandingDescription5" value="<?php echo get_option('revCategoryLandingDescription5'); ?>"  style="width:100%;" /></td>
 ...
 <div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div>
                    <h3 class="hndle"><span>Basic Styling <small>(optional)</small></span></h3>
            <div class="inside">
...
<div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div>
                    <h3 class="hndle"><span>Custom CSS <small>(optional)</small></span></h3>
                    <div class="inside">
...
<th scope="row">
                        <textarea name="revCustomCSS" style="width:100%" cols="" rows="10" id="revCustomCSS"><?php echo get_option('revCustomCSS'); ?></textarea>
                      </th>
                ...
                <div class="postbox closed" id="test2">
                    <div title="Click to toggle" class="handlediv"><br></div><h3 class="hndle"><span>BRAGbook Advanced Options <small>(optional)</small></span></h3>
                    <div class="inside"> 
                    <p>These options provide the ability to wrap various elements of the gallery in extra html tags so  advanced custom styling can be added.
                    <table class="form-table">
