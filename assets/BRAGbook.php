...
$string = strtr( $string, $unwanted_array );
   return preg_replace('/[^A-Za-z0-9\-_]/', '', $string); // Removes special chars.
		...
		for ($x=$categorySetsStart; $x<$recordLimit; $x++){
				if(isset($this->baGallery['ba_set'][$x]['oid'])){
					if($this->urlRewrite == true){  
						...
						if($this->showCatSetDetails == 1){
							if(isset($catComboIm) && $catComboIm != "") {
								$revCategoryLandingPageImageSetsOutput .=  '<li class="revCatImageSet  revSingleCol"><div class="revCatCol1"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revCatImageSetCenter"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a></div><div class="revCatCol2">'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'" class="revCaseViewLink">View More</a></div></li>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
							...
							if(isset($catComboIm) && $catComboIm != "") {
								$revCategoryLandingPageImageSetsOutput .=  '<li class="revCatImageSet revDoubleCol">'.$revHead.'<a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revCatImageSetCenter"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a></li>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
						...
						if($this->showCatSetDetails == 1){	
							if(isset($catComboIm) && $catComboIm != ""){
								$revCategoryLandingPageImageSetsOutput .=  '<li class="revCatImageSet revSingleCol"><div class="revCatCol1"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revCatImageSetCenter"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a></div><div class="revCatCol2">'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'" class="revCaseViewLink">View More</a></div></li>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
							...
							if(isset($catComboIm) && $catComboIm != ""){
								$revCategoryLandingPageImageSetsOutput .=  '<li class="revCatImageSet revDoubleCol">'.$revHead.'<a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revCatImageSetCenter"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a></li>';
							}if(isset($catAfterIm) && $catAfterIm !=""){
		...
		for ($x=$categorySetsStart; $x<$recordLimit; $x++){
				if(isset($this->baGallery['ba_set'][$x]['oid'])){
					if($this->urlRewrite == true){  
						...
						if($this->showCatSetDetails == 1){
							if(isset($catComboIm) && $catComboIm != ""){
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet  revSlideSingleCol"><div class="revDetailsDiv"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revSlideImageSetCenter"><img loading="lazy"  alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a>'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'" class="revSlideCaseViewLink">View More</a></div></div>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
							...
							if(isset($catComboIm) && $catComboIm != ""){
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revSlideImageSetCenter"><img loading="lazy" alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a></div>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
						...
						if($this->showCatSetDetails == 1){	
							if(isset($catComboIm) && $catComboIm != ""){
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet revSingleCol"><div class="revDetailsDiv"><div class="revCatCol1"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revCatImageSetCenter"><img loading="lazy" alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a>'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'" class="revSlideCaseViewLink">View More</a></div></div>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
							...
							if(isset($catComboIm) && $catComboIm != ""){
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revSlideImageSetCenter"><img loading="lazy"  alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$x]['angle1_combo_hr'].'"></span></a></div>';
							} else if(isset($catAfterIm) && $catAfterIm !=""){
	...
	function revImageSet($revCatname,$revID){
		...
		if(isset($this->baGallery['ba_set'][$this->revStart]['image_after'.$i2."_hr"])){
		...
		if(isset($this->baGallery['ba_set'][$this->revStart]['image_after_2_hr'])){
    ...
    <div class="pswp__scroll-wrap">
		...
		//BA set 1
			if(isset($this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr_x3'])){
				...
				$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'].'" itemprop="contentUrl" data-size="'.$widthB.'x'.$heightB.'" class="psLink"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr_x3'].'"></a><figcaption itemprop="caption description" style="display:none">Before / After Angle 1</figcaption></figure></div>'; 
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'])){
				$widthB = $this->baGallery['ba_set'][$this->revStart]['image_combo_hr_width'];
				$heightB = $this->baGallery['ba_set'][$this->revStart]['image_combo_hr_height'];

				$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'].'" itemprop="contentUrl" data-size="'.$widthB.'x'.$heightB.'" class="psLink"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'].'"></a><figcaption itemprop="caption description" style="display:none">Before / After Angle 1</figcaption></figure></div>'; 
			}else if(isset($this->baGallery['ba_set'][$this->revStart]['image_after_2_hr'])){
			...
			$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure  class="revBAcol1" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['image_before_hr'].'" itemprop="contentUrl" data-size="'.$widthB.'x'.$heightB.'" class="psLink"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_before_hr'].'"></a><figcaption itemprop="caption description" style="display:none">Before Angle 1</figcaption></figure><figure  class="revBAcol2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['image_after_hr'].'" itemprop="contentUrl" data-size="'.$widthA.'x'.$heightA.'" class="psLink"><img alt="'.$altA1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after_hr'].'"></a><figcaption itemprop="caption description" style="display:none">After Angle 1</figcaption></figure></div>'; 
		} else {
			$widthB = $this->baGallery['ba_set'][$this->revStart]['image_before_hr_width'];
			$heightB = $this->baGallery['ba_set'][$this->revStart]['image_before_hr_height'];
		...
		for($i=1; $i<10; $i++){
			$curAngle = $i+1;
			if(isset($this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr_x3'])){
					...
					$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr'].'" itemprop="contentUrl" data-size="'.$widthB.'x'.$heightB.'" class="psLink"><img alt="'.${'altCombo'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_hr_x3'].'"></a><figcaption itemprop="caption description" style="display:none">Before / After Angle '.($i+1).'</figcaption></figure></div>';
		 
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr'])){
				
					
					$widthB = $this->baGallery['ba_set'][$this->revStart]['image_combo'.$curAngle.'_hr_width'];
					$heightB = $this->baGallery['ba_set'][$this->revStart]['image_combo'.$curAngle.'_hr_height'];
					
					$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr'].'" itemprop="contentUrl" data-size="'.$widthB.'x'.$heightB.'" class="psLink"><img alt="'.${'altCombo'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr'].'"></a><figcaption itemprop="caption description" style="display:none">Before / After Angle '.($i+1).'</figcaption></figure></div>';
		 
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_2_hr'])){
			...
			$heightA2 = $this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_2_hr_height'];
				...
				if(isset($this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'])){
					...
					$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure  class="revBAcol1" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'].'" itemprop="contentUrl" data-size="'.$widthB.'x'.$heightB.'" class="psLink"><img alt="'.${'altB'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'].'"></a><figcaption itemprop="caption description" style="display:none">Before Angle '.($i+1).'</figcaption></figure><figure  class="revBAcol2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_hr'].'" itemprop="contentUrl" data-size="'.$widthA.'x'.$heightA.'" class="psLink"><img alt="'.${'altA'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_hr'].'"></a><figcaption itemprop="caption description" style="display:none">After Angle '.($i+1).'</a></figcaption></figure></div>'; 
		 }
			} else{
				if(isset($this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'])){
					$widthB = $this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr_width'];
			...
			//BA set 1
			if(isset($this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr_x3'])){
				$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr_x3'].'"><figcaption itemprop="caption description" style="display:none">Before / After Angle 1</figcaption></figure></div>'; 
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'])){
				$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'].'"><figcaption itemprop="caption description" style="display:none">Before / After Angle 1</figcaption></figure></div>'; 
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['image_after_2_hr'])){
			$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure  class="revBAcol1-3"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_before_hr'].'"><figcaption itemprop="caption description" style="display:none">Before Angle 1</figcaption></figure><figure  class="revBAcol2-3"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.$altA1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after_hr'].'"><figcaption itemprop="caption description" style="display:none">After Angle 1</figcaption></figure><figure  class="revBAcol3-3"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.$altA1_2.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after_2_hr'].'"><figcaption itemprop="caption description" style="display:none">After 2 Angle 1</figcaption></figure></div>'; 
		} else if($this->baGallery['ba_set'][$this->revStart]['image_after_hr']){
		...
		for($i=1; $i<10; $i++){
			...
			if(isset($this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr_x3'])){
				list($widthB, $heightB) = getimagesize($this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr']);
					...
					$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altCombo'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr_x3'].'"><figcaption itemprop="caption description" style="display:none">Before / After Angle '.($i+1).'</figcaption></figure></div>';
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr'])){
				list($widthB, $heightB) = getimagesize($this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr']);
					
					$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure class="revBAcol" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altCombo'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle'.$curAngle.'_combo_hr'].'"><figcaption itemprop="caption description" style="display:none">Before / After Angle '.($i+1).'</figcaption></figure></div>';
			} else if(isset($this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_2_hr'])){
			if(isset($this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'])){				
				$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure  class="revBAcol1-3"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altB'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'].'"><figcaption itemprop="caption description" style="display:none">Before Angle '.($i+1).'</figcaption></figure><figure  class="revBAcol2-3"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altA'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_hr'].'"><figcaption itemprop="caption description" style="display:none">After Angle '.($i+1).'</figcaption></figure><figure  class="revBAcol3-3"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altA'.($i+1)}.'_2" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_2_hr'].'"><figcaption itemprop="caption description" style="display:none">After 2 Angle '.($i+1).'</figcaption></figure></div>'; 
		 }
			} else if($this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_hr']){
				if(isset($this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'])){					
					$revImageSetOutput .= '<div class="revBArow revBA-gallery" itemscope itemtype="http://schema.org/ImageGallery"><figure  class="revBAcol1" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altB'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'].'"><figcaption itemprop="caption description" style="display:none">Before Angle '.($i+1).'</figcaption></figure><figure  class="revBAcol2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject"><img alt="'.${'altA'.($i+1)}.'" src="'.$this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_hr'].'"><figcaption itemprop="caption description" style="display:none">After Angle '.($i+1).'</figcaption></figure></div>'; 
		 }
			} else{
				if(isset($this->baGallery['ba_set'][$this->revStart]['image_before'.$i.'_hr'])){
	...
	function revGetFirstAngle($revID){
		...
		//BA set 1
		if(isset($catComboIm) && $catComboIm != "") {
			$revImageSetOutput .= '<div class="revBArow"><div class="revBAcol"><img alt="'.$altCombo1.'" src="'.$this->baGallery['ba_set'][$this->revStart]['angle1_combo_hr'].'"></div><div class="clearfixer"></div></div>'; 
		} else if(isset($this->baGallery['ba_set'][$this->revStart]['image_after_2_hr'])){
		...
		$revThumbnailsOutput .= '<div><ul id="revThumbnails">';
			for ($x=$thumbStart; $x<$recordLimit; $x++){
				if(isset($this->baGallery['ba_set'][$x]['oid'])){
					...
					if(isset($this->baGallery['ba_set'][$x]['image_after_hr'])){
