...
class revGallery{
	...
	var $revLandingDescription = "Plastic surgery before and after image";
   ...
   return preg_replace('/[^A-Za-z0-9\-_]/', '', $string); // Removes special chars.
				...
				if(isset($this->baGallery['ba_set'][$x]['oid'])){
					if($this->urlRewrite == true){  
						...
						if(isset($catAfterIm) && $catAfterIm !=""){
							if($this->baGallery['ba_set'][$x]['custom_alttag'] == ""){$altB1 = $curCatname . " - " . "Before Image ";}else{${'altB1'} = $this->baGallery['ba_set'][$x]['custom_alttag']." - Before Image";}
						} else{
							if($this->baGallery['ba_set'][$x]['custom_alttag'] == ""){$altB1 = $curCatname . " - " . "Before and After Image ";}else{${'altB1'} = $this->baGallery['ba_set'][$x]['custom_alttag']." - Before and After Image";}
						}

						if($this->baGallery['ba_set'][$x]['custom_alttag'] == ""){$altA1 = $curCatname . " - " . "After Image ";}else{${'altA1'} = $this->baGallery['ba_set'][$x]['custom_alttag']." - After Image" ;}
		...
		for ($x=$categorySetsStart; $x<$recordLimit; $x++){
				if(isset($this->baGallery['ba_set'][$x]['oid'])){
					if($this->urlRewrite == true){  
						...
						if($this->showCatSetDetails == 1){
							if(isset($catAfterIm) && $catAfterIm !=""){
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet revSlideSingleCol"><div class="revDetailsDiv"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revSlideImageSetLeft"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_xl'].'"></span><span  class="revSlideImageSetRight"><img alt="'.$altA1.'" src="'.$catAfterIm.'"></span></a>'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'" class="revSlideCaseViewLink">View More</a></div></div>';
							}else {
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet  revSlideSingleCol"><div class="revDetailsDiv"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revSlideImageSetCenter"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_single'].'"></span></a>'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'" class="revSlideCaseViewLink">View More</a></div></div>';
							}
						} else{
							if(isset($catAfterIm) && $catAfterIm !=""){
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revSlideImageSetLeft"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_xl'].'"></span><span  class="revSlideImageSetRight"><img alt="'.$altA1.'" src="'.$catAfterIm.'"></span></a></div>';
							}else {
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet"><a href="'.$this->baseUrl.$revCatname.'/'.$revLink.'/'.$this->galleryAnchor.'"><span class="revSlideImageSetCenter"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_single'].'"></span></a></div>';
							}
						...
						if($this->showCatSetDetails == 1){	
							if(isset($catAfterIm) && $catAfterIm !=""){
							$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet revSlideSingleCol"><div class="revDetailsDiv"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revCatImageSetLeft"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_xl'].'"></span><span class="revCatImageSetRight"><img alt="'.$altA1.'" src="'.$catAfterIm.'"></span></a>'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'" class="revSlideCaseViewLink">View More</a></div></div>';
							}else {
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet revSingleCol"><div class="revDetailsDiv"><div class="revCatCol1"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revCatImageSetCenter"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_single'].'"></span></a>'.$revHead.'<p>'.$this->truncate($this->revPatientDetailPreview($this->baGallery['ba_set'][$x]['oid']), 150).'</p><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'" class="revSlideCaseViewLink">View More</a></div></div>';
							}
						} else{
							if(isset($catAfterIm) && $catAfterIm !=""){
							$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revSlideImageSetLeft"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_xl'].'"></span><span class="revSlideImageSetRight"><img alt="'.$altA1.'" src="'.$catAfterIm.'"></span></a></div>';
							}else {
								$revCategoryLandingPageImageSetsOutput .=  '<div class="revSlideImageSet"><a href="'.$this->baseUrl.'?revCatname='.$revCatname.'&revStart='.$revLink.$this->galleryAnchor.'"><span class="revSlideImageSetCenter"><img alt="'.$altB1.'" src="'.$this->baGallery['ba_set'][$x]['image_before_single'].'"></span></a></div>';
							}
						}
	...
	function revImageSet($revCatname,$revID){
		...
		if(isset($this->baGallery['ba_set'][$this->revStart]['image_after'.$i2."_xl"])){
			if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altB'.$i} = $curCatname . " - " . "Before Image ".$i;}else{${'altB'.$i} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - Before Image ".$i;}
		}else{
			if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altB'.$i} = $curCatname . " - " . "Before and After Image ".$i;}else{${'altB'.$i} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - Before and After Image ".$i;}
		}
		
		if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altA'.$i} = $curCatname . " - " . "After Image ".$i;}else{${'altA'.$i} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - ".isset($time1)." After Image ".$i ;}
		
		if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altA'.$i.'_2'} = $curCatname . " - " . "After Image ".$i;}else{${'altA'.$i.'_2'} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - ".isset($time2)." After Image ".$i ;}
    ...
    <div class="pswp__scroll-wrap">
		...
		for($i=1; $i<10; $i++){
			...
			if(isset($this->baGallery['ba_set'][$this->revStart]['image_after'.$i.'_2_xl'])){
	...
	function revGetFirstAngle($revID){
		...
		if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altB'.$i} = "Before Image ".$i;}else{${'altB'.$i} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - Before Image ".$i;}
		
		if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altA'.$i} = "After Image ".$i;}else{${'altA'.$i} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - ".isset($time1)." After Image ".$i ;}
		
		if($this->baGallery['ba_set'][$this->revStart]['custom_alttag'] == ""){${'altA'.$i.'_2'} = "After Image ".$i;}else{${'altA'.$i.'_2'} = $this->baGallery['ba_set'][$this->revStart]['custom_alttag']." - ".isset($time2)." After Image ".$i ;}
