...
Plugin URI: https://www.bragbook.gallery/wp-plugin/
...
function bragbook_plugin_scripts(){
	...
	if(get_option( 'revClickToZoomActive',0) == 1){
		wp_register_script('photoswipe_script',plugin_dir_url( __FILE__ ).'assets/photoswipe.min.js',array( 'jquery' ));
		wp_enqueue_script('photoswipe_script');

		wp_register_script('photoswipe_ui_script',plugin_dir_url( __FILE__ ).'assets/photoswipe-ui-default.min.js',array( 'jquery' ));
		wp_enqueue_script('photoswipe_ui_script');
		
		wp_register_script('photoswipe_init_script',plugin_dir_url( __FILE__ ).'assets/photoswipe-init.min.js',array( 'jquery' ));
		wp_enqueue_script('photoswipe_init_script');

		wp_register_style('photoswipe_style',plugin_dir_url( __FILE__ ).'assets/photoswipe.css');
		wp_enqueue_style('photoswipe_style');

		wp_register_style('photoswipe_skin_style',plugin_dir_url( __FILE__ ).'assets/default-skin/default-skin.css');
